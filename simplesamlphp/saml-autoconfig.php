...
# todo: change puppet to just write idp md file to /opt/saml/idp_metadata.xml
$metadata_url_for = [
    'helloslowstaging' => '/opt/saml/idp_metadata_staging.xml'
//    'helloslowstaging' => 'https://hellosign.okta.com/app/exkk43fls20mx5tJr0x7/sso/saml/metadata'
];
...
foreach($metadata_url_for as $idp_name => $metadata_url) {
    ...
    $config[$idp_name] = array(
        ...
        'privatekey' => '/opt/saml/saml.pem',
        'certificate' => '/opt/saml/saml.crt',
